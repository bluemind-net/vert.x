...
public class Deployment {
	...
	public final VerticleConstructor main;
	...
	public Deployment(String name, VerticleConstructor main, ModuleIdentifier modID, int instances, JsonObject config,
			URL[] classpath, URL[] includedClasspath, File modDir, String parentDeploymentName,
			ModuleReference moduleReference, boolean autoRedeploy, boolean ha, boolean loadFromModuleFirst) {
		this.name = name;
		this.main = main;
		this.modID = modID;
